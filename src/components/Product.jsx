    ...
    const handlerQuantity = (event) => {
        ...
        if(newQuantity == '') {
            ...
            if(quantityMessage) {
                ...
                setTimeout(() => quantityEmpty && toggleQuantityEmpty(), 900)
            }else {
                quantityEmpty && toggleQuantityEmpty()
            }
        ...
        <article className="product--modal">
            ...
            <div className="title-price--modal">
                ...
                <div className='quantity'>
                    <p>Cantidad: </p>
                    <input onChange={handlerQuantity} className={(quantityEmpty ? "quantity__input input--error" : "quantity__input")} type='number' defaultValue={product.quantity} min='0' />
                </div>
                {quantityEmpty && <p className='quantity__message message-fade-in'>Por favor, ingrese una cantidad</p>}
